...
- Each snapshot stores internal state, public state, and projection metadata so `/api/live/board` and stabilized public ordering can recover more faithfully after restarts.
